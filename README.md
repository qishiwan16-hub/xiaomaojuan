...
- 首页信息展示
- 首页设置区收纳为单一“设置中心”入口
- 设置中心内部页（基础设置 / 主题外观 / 字体管理 / 高级项预留）
- 内置 Termux 字体预设安装 / 恢复默认字体 / 重新加载设置
- 菜单占位页与占位跳转
...
- 首页设置区现在只保留一个“设置中心”入口，详细设置项已收纳到内部页
- 设置中心里的字体管理可以安装内置的霞鹜文楷等宽到 `~/.termux/font.ttf`
- 当前内置字体预设使用真实可访问的 `.ttf` 直链，并带有 MD5 校验，避免把失效页面写成字体文件
